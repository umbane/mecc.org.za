...
<head>
  <meta charset="utf-8">
  <title>Muizenberg Electricity Co-Op</title>
              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    <p class="intro-title-top">Muizenberg Energy Festival
                      <br>21 June 2023</p>
                    <h1 class="intro-title mb-4">
                      <span class="color-b">Muizenberg </span>
                      <br>Energy Festival 21 June 2023 </h1>
                    <p class="intro-subtitle intro-price">
                      <a href="https://mailchi.mp/a79848b4019d/5m5we5dtew" target="new"><span class="price-a">Register Now</span></a>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div class="col-md-4">
          <div class="card-box-c foo">
            ...
            <div class="card-footer-c">
              <a href="https://muizenmesh.co.za/store/" class="link-c link-icon" target="new">Go There
        ...
        <div class="col-md-4">
          <div class="card-box-c foo">
            <div class="card-header-c d-flex">
              ...
              <div class="card-title-c align-self-center">
                <h2 class="title-c">Knowledge Base</h2>
              </div>
            </div>
            <div class="card-body-c">
              <p class="content-c">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="title-wrap d-flex justify-content-between">
            <div class="title-box">
              <h2 class="title-a">Current Campaigns</h2>
            </div>
            
            <!--
            <div class="title-link">
              <a href="property-grid.html">All Campaigns
                <span class="ion-ios-arrow-forward"></span>
              </a>
            </div>
            -->
      ...
      <div id="property-carousel" class="owl-carousel owl-theme">
        <div class="carousel-item-b">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="img/slide-1.jpg" alt="" class="img-a img-fluid">
            </div>
              ...
              <div class="card-overlay-a-content">
                ...
                <!--
                  <div class="price-box d-flex">
                    <span class="price-a">21 June 2023</span>
                  </div>
                  -->
                  
                  <a href="https://mailchi.mp/a79848b4019d/5m5we5dtew" class="link-a" target="new">Register
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
                </div>
        ...
        <div class="carousel-item-b">
          <div class="card-box-a card-shadow">
            <div class="img-box-a">
              <img src="img/slide-2.jpg" alt="" class="img-a img-fluid">
            </div>
            <div class="card-overlay">
              <div class="card-overlay-a-content">
                <div class="card-header-a">
                ...
                <!--
                  ...
                  <a href="https://form.jotform.com/231292009197557" class="link-a" target="_new">Join
                    <span class="ion-ios-arrow-forward"></span>
                  </a>
                </div>
        ...
        <div class="col-sm-12 col-md-4">
          <div class="widget-a">
            <div class="w-header-a">
              <h3 class="w-title-a text-brand">>Muizenberg Electricity Co-Op</h3>
            </div>
            <div class="w-body-a">
        ...
        <!-- 
          ...
          <div class="copyright-footer">
            <p class="copyright color-text-a">
              &copy; Copyright
              <span class="color-a">Muizenberg Electricity Co-Op</span> All Rights Reserved.
            </p>
          </div>
          <div class="credits">
            <!--
